...
VERSION = "3.0-PRO"
PROFILE = "TLS certificate chain and PKI posture auditor"
RULES = [('TLS-IDENTITY', 'subject|issuer|subjectAltName|SAN'), ('TLS-TIME', 'not before|not after|expired|validity'), ('TLS-CRYPTO', 'sha256|RSA|ECDSA|TLSv1\\.[23]|cipher')]
...
def render_banner() -> None:
 ...
 | |__| | | | | |__| | |__| || |_
  \\_____|_| |_|\\____/ \\____/_____|
      GHOST-TLSPKIAnalyzer v3.0-PRO (Zero-Guessing Engine)
"""
    print(banner)
